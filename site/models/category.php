...
/**
 * Hiots Component Hiot Model
 *
 * @since  1.5
 */
class HiotsModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	...
	/**
	 * The list of other hiot categories.
	 *
	 * @var  array
	 */
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			$item->tags->getItemTags('com_hiots.hiot', $item->id);
		}
...
/*		$this->setState('list.ordering', $orderCol);
	...
	*/
		...
		if ((!$user->authorise('core.edit.state', 'com_hiots')) && (!$user->authorise('core.edit', 'com_hiots')))
		{
	...
	public function getCategory()
	{
		if (!is_object($this->_item))
		{
			...
			$categories = JCategories::getInstance('Hiots', $options);
