...
class HiotsControllerHdevrec extends JControllerForm
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Hdevrec', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_hiots&view=hdevrecs' . $this->getRedirectToListAppend(), false));
	...
	protected function postSaveHook(JModelLegacy $model, $validData = array())
	{
		...
		if ($task == 'save')
		{
			$this->setRedirect(JRoute::_('index.php?option=com_hiots&view=hdevrecs', false));
		}
	}
}
