...
/**
 * Methods supporting a list of hdevrec records.
 *
 * @since  1.6
 */
class HiotsModelHdevrecs extends JModelList
{
	 ...
	 * @since   1.6
	 */
	protected function populateState($ordering = 'a.tdate', $direction = 'desc')
	{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__hiots_records', 'a'));
		...
		if (is_numeric($tagId))
		{
			$query->where($db->quoteName('tagmap.tag_id') . ' = ' . (int) $tagId)
				->join(
					...
					. ' AND ' . $db->quoteName('tagmap.type_alias') . ' = ' . $db->quote('com_hiots.hdevrec')
				);
		}
*/
		// Add the list ordering clause.
		$orderCol  = $this->state->get('list.ordering', 'a.tdate');
		$orderDirn = $this->state->get('list.direction', 'ASC');

		if ($orderCol == 'a.ordering' || $orderCol == 'category_title')
		{
			$orderCol = 'c.tdate ' . $orderDirn . ', a.ordering';
		}
